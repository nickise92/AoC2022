...
def solve(file, part_2=False, print_crates=False):
    ...
    # Everything before the empty line (minus the ' 1 2 3 ...')
    crate_lines = lines[:lines.index('\n')-1]

    # iterate over the crates fromt he bottom to the top
